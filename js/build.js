...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Zh58VX"))},{"./batch":1,"./sub":13,Zh58VX:92,events:86,"level-fix-range":3,"level-hooks":5}],3:[function(t,e){var n=t("clone")
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:82}],5:[function(t,e){var n=t("string-range")
...
e.exports=n},{"./batch":1,events:86,"level-fix-range":3,"string-range":6,util:113,xtend:8}],14:[function(t,e){function n(t,e){this._levelup=t,this._codec=e,this.batch=t.db.batch(),this.ops=[]}var r=t("./util"),i=t("./errors").WriteError,o=r.getOptions,a=r.dispatchError
...
return this.isOpen()?r.setIterator(e.db.iterator(t)):this.once("ready",function(){r.setIterator(e.db.iterator(t))}),r},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(l(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(l(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new E(l(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=_.copy,e.exports.destroy=u("destroy"),e.exports.repair=u("repair")}).call(this,t("Zh58VX"))},{"./batch":14,"./codec":15,"./errors":17,"./read-stream":19,"./util":20,"./write-stream":21,Zh58VX:92,"deferred-leveldown":23,events:86,prr:29,util:113,xtend:40}],19:[function(t,e){function n(t,e){return this instanceof n?(r.call(this,{objectMode:!0,highWaterMark:t.highWaterMark}),this._waiting=!1,this._options=t,void(this._makeData=e)):new n(t,e)}{var r=t("readable-stream").Readable,i=t("util").inherits,o=(t("xtend"),t("./errors").EncodingError)
...
return t}()
e.exports={defaultOptions:l,copy:n,getOptions:r,getLevelDOWN:i,dispatchError:o,isDefined:a}},{"../package.json":41,"./encodings":16,"./errors":17,leveldown:81,"leveldown/package":81,semver:81,xtend:40}],21:[function(t,e){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:92}],25:[function(t,e){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:92}],26:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
s.inherits(r,u),o(a(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Zh58VX"))},{"./_stream_readable":32,"./_stream_writable":34,Zh58VX:92,"core-util-is":35,inherits:36}],31:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],44:[function(t,e){e.exports=t(24)},{Zh58VX:92}],45:[function(t,e){e.exports=t(25)},{Zh58VX:92}],46:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
this.location=t}var o=t("xtend"),a=t("./abstract-iterator"),s=t("./abstract-chained-batch")
i.prototype.open=function(t,e){if("function"==typeof t&&(e=t),"function"!=typeof e)throw new Error("open() requires a callback argument")
return"object"!=typeof t&&(t={}),"function"==typeof this._open?this._open(t,e):void n.nextTick(e)},i.prototype.close=function(t){if("function"!=typeof t)throw new Error("close() requires a callback argument")
...
return t=o(t),["start","end","gt","gte","lt","lte"].forEach(function(n){t[n]&&e._isBuffer(t[n])&&0===t[n].length&&delete t[n]}),t.reverse=!!t.reverse,t.reverse&&t.lt&&(t.start=t.lt),t.reverse&&t.lte&&(t.start=t.lte),!t.reverse&&t.gt&&(t.start=t.gt),!t.reverse&&t.gte&&(t.start=t.gte),(t.reverse&&t.lt&&!t.lte||!t.reverse&&t.gt&&!t.gte)&&(t.exclusiveStart=!0),t},i.prototype.iterator=function(t){return"object"!=typeof t&&(t={}),t=this._setupIteratorOptions(t),"function"==typeof this._iterator?this._iterator(t):new a(this)},i.prototype._chainedBatch=function(){return new s(this)},i.prototype._isBuffer=function(t){return r.isBuffer(t)},i.prototype._checkKeyValue=function(t,e){if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(this._isBuffer(t)){if(0===t.length)return new Error(e+" cannot be an empty Buffer")}else if(""===String(t))return new Error(e+" cannot be an empty String")},e.exports.AbstractLevelDOWN=i,e.exports.AbstractIterator=a,e.exports.AbstractChainedBatch=s}).call(this,t("Zh58VX"),t("buffer").Buffer)},{"./abstract-chained-batch":44,"./abstract-iterator":45,Zh58VX:92,buffer:82,xtend:48}],47:[function(t,e){e.exports=t(7)},{}],48:[function(t,e,n){arguments[4][8][0].apply(n,arguments)},{"./has-keys":47,"object-keys":50}],49:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===r.call(t)
...
return u}},{}],59:[function(t,e){var n=t("stringmap"),r=t("level-sublevel"),i=t("asynquence"),o=t("events").EventEmitter,a=t("expire-unused-keys"),s=t("extend")
...
return v.on("expire",l),g.on("expire",h),y.stop=c,y.get=function(t,e){p.get(t,function(n,r){n&&n.notFound?l(t,f(t,e)):e&&f(t,e)(n,r)})},y.getLocal=function(t,e){p.get(t,f(t,e))},y.refresh=function(t,e){l(t,f(t,e))},y}},{asynquence:57,events:86,"expire-unused-keys":60,extend:58,"level-sublevel":2,stringmap:61}],60:[function(t,e){function n(t){function e(){n=!1}var n=!1
...
return o.touch=o.emit.bind(o,"touch"),o.forget=o.emit.bind(o,"forget"),o.stop=function(){clearInterval(u)},o}},{events:86}],61:[function(t,e){var n=function(){"use strict"
...
"undefined"!=typeof e&&"undefined"!=typeof e.exports&&(e.exports=n)},{}],62:[function(t,e){var n=t("http"),r=t("url"),i=t("text-metadata-parser")
...
return n.filename=t,n})}}}},{http:87,"text-metadata-parser":63,url:111}],63:[function(t,e){function n(t){for(var e=t.split("\n"),n=!1,r=!1,i={content:"",metadata:{}},o=0;o<e.length&&!r;o++)if(n)r||(r=!/^\s*$/.test(e[o]))
else{var a=/^([^:]+):\s*([^\r\n]+)\s*$/.exec(e[o])
...
e.exports=function(t){return u.extend(t)}},{extend:58}],65:[function(t,e){function n(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
...
return e.linkify=r.bind(null,e,t),e}},{events:86}],66:[function(t,e){function n(t,e){function n(t){u.mixinHtml(t),u.parseTemplate(t),u.mixinChildPosts(t),u.mixinRenderedHtmlEmitter(t),t.on("all child posts fetched",function(t){t.templateElements.forEach(n)})}function i(t,e){var r=u.makeNewMixinObject(t)
...
e.exports=n},{"./mixins":67}],67:[function(t,e){(function(n){function r(t){try{return new p({el:null,data:t.data,template:t.renderedHtml||t.html,preserveWhitespace:!0}).toHTML()}catch(e){return t.emit("error",e),e.message}}function i(t){var e=Object.create(new d)
...
"undefined"!=typeof e&&e.exports?e.exports=fo:"function"==typeof define&&define.amd&&define(function(){return fo}),t.Ractive=fo,fo.noConflict=function(){return t.Ractive=n,fo}}("undefined"!=typeof window?window:this)},{}],69:[function(t,e){e.exports=function(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}},{}],70:[function(t,e){function n(){return Object.create(new s)}function r(t,e){var n=Object.create(t),r=0
...
e.exports=i},{"./numberOfOccurrances":69,"./templateToolbox":71,events:86}],71:[function(t,e){function n(t){return t.metadata.markdown!==!1?h.makeHtml(t.content):t.content}function r(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(t){var e=16*Math.random()|0,n="x"==t?e:3&e|8
...
e.exports={generateId:i,getPostName:o,generatePostDiv:s,isAPostDiv:a,getTemplateDataObject:u,htmlify:n}},{pagedown:79}],72:[function(t,e){e.exports=function(t){var e={}
return t.on("post changed",function(t,n){e[t]&&e[t].forEach(function(t){t.emit("post changed",n)})}),function(t){"undefined"==typeof e[t.postName]&&(e[t.postName]=[]),e[t.postName].push(t),t.ractive.on("teardown",function(){e[t.postName]=e[t.postName].filter(function(e){return e!==t})})}}},{}],73:[function(t,e){var n=t("levelup"),r=t("localstorage-down"),i=function(t){return new r(t)}
e.exports={clearCache:function(){var t=n("noddity-content",{db:i})
t.createKeyStream().on("data",function(e){t.del(e)})}}},{levelup:18,"localstorage-down":42}],74:[function(t){var e=t("noddity-butler"),n=t("levelup"),r=t("noddity-linkifier"),i=t("localstorage-down"),o=t("./routing"),a=t("./mainViewModel"),s=t("level-sublevel"),u=noddityConfig,c=function(t){return new i(t)},h=s(n("noddity-content",{db:c})),l=u.title.replace(/[^\w]+/g,""),f=u.debug?{refreshEvery:3e4}:void 0,d=new e(u.noddityRoot,h.sublevel(l),f),p=new r(u.pathPrefix+u.pagePathPrefix),g=new a(d,p),v=o()
v.on("current",g.setCurrent),u.debug&&(window.debug=t("./debug"))},{"./debug":73,"./mainViewModel":75,"./routing":76,"level-sublevel":2,levelup:18,"localstorage-down":42,"noddity-butler":53,"noddity-linkifier":65}],75:[function(t,e){function n(){}var r=t("ractive"),i=noddityConfig,o=t("noddity-renderer")
...
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?g.set("html",t.message):h.populateRootRactive(e,g)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",s),{setCurrent:u}}},{"noddity-renderer":66,ractive:80}],76:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return setTimeout(e.go.bind(e),0),t}},{events:86}],77:[function(t,e,n){var r
...
return s})}()},{}],91:[function(t,e){e.exports=t(36)},{}],92:[function(t,e){function n(){}var r=e.exports={}
...
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":94,"./encode":95}],97:[function(t,e){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":98}],98:[function(t,e){e.exports=t(30)},{"./_stream_readable":100,"./_stream_writable":102,Zh58VX:92,"core-util-is":103,inherits:91}],99:[function(t,e){e.exports=t(31)},{"./_stream_transform":101,"core-util-is":103,inherits:91}],100:[function(t,e){e.exports=t(32)},{Zh58VX:92,buffer:82,"core-util-is":103,events:86,inherits:91,isarray:104,stream:110,"string_decoder/":105}],101:[function(t,e){e.exports=t(33)},{"./_stream_duplex":98,"core-util-is":103,inherits:91}],102:[function(t,e){e.exports=t(34)},{"./_stream_duplex":98,Zh58VX:92,buffer:82,"core-util-is":103,inherits:91,stream:110}],103:[function(t,e){e.exports=t(35)},{buffer:82}],104:[function(t,e){e.exports=t(37)},{}],105:[function(t,e){e.exports=t(38)},{buffer:82}],106:[function(t,e){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":99}],107:[function(t,e){e.exports=t(39)},{"./lib/_stream_duplex.js":98,"./lib/_stream_passthrough.js":99,"./lib/_stream_readable.js":100,"./lib/_stream_transform.js":101,"./lib/_stream_writable.js":102,stream:110}],108:[function(t,e){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":101}],109:[function(t,e){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":102}],110:[function(t,e){function n(){r.call(this)}e.exports=n
...
return t}}).call(this,t("Zh58VX"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":112,Zh58VX:92,inherits:91}]},{},[74])
