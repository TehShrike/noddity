...
i.clear=function(){this._operations=[]},i.write=function(t){this._sdb.batch(this._operations,t)},e.exports=r},{}],2:[function(t,e){(function(n){var r=(t("events").EventEmitter,n.nextTick,t("./sub")),i=t("./batch"),o=t("level-fix-range"),s=t("level-hooks")
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Zh58VX"))},{"./batch":1,"./sub":13,Zh58VX:103,events:97,"level-fix-range":3,"level-hooks":5}],3:[function(t,e){var n=t("clone")
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:94}],5:[function(t,e){var n=t("string-range")
...
return a(!1,r,e,n)},t.batch=function(t,e,n){return a(!0,t,e,n)}}}},{"string-range":6}],6:[function(t,e,n){{var r=n.range=function(t){return null==t?{}:"string"==typeof r?{min:r,max:r+"ÿ"}:t},i=(n.prefix=function(t,e,r){t=n.range(t)
var i={}
...
else for(var a in t)n.call(t,a)&&e.call(i,t[a],a,t)}},{}],11:[function(t,e){var n=Object.prototype,r=n.hasOwnProperty,i=n.toString,o=function(t){return t!==t},s={"boolean":1,number:1,string:1,undefined:1},a=e.exports={}
...
return r||t>=e&&n>=t},a.object=function(t){return t&&"[object Object]"===i.call(t)},a.hash=function(t){return a.object(t)&&t.constructor===Object&&!t.nodeType&&!t.setInterval},a.regexp=function(t){return"[object RegExp]"===i.call(t)},a.string=function(t){return"[object String]"===i.call(t)}},{}],12:[function(t,e){!function(){"use strict"
...
return s&&o(a,function(e){r.call(t,e)&&n.push(e)}),n},e.exports=n}()},{foreach:10,is:11}],13:[function(t,e){function n(t,e,r){if("string"==typeof r&&(console.error("db.sublevel(name, seperator<string>) is depreciated"),console.error("use db.sublevel(name, {sep: separator})) if you must"),r={sep:r}),!(this instanceof n))return new n(t,e,r)
...
e.exports=n},{"./batch":1,events:97,"level-fix-range":3,"string-range":6,util:124,xtend:8}],14:[function(t,e){function n(t){this._levelup=t,this.batch=t.db.batch(),this.ops=[]}var r=t("./util"),i=t("./errors").WriteError,o=r.getOptions,s=r.dispatchError
...
try{this.batch.write(function(r){return r?s(e,new i(r),t):(e.emit("batch",n),void(t&&t()))})}catch(r){throw new i(r)}},e.exports=n},{"./errors":15,"./util":18}],15:[function(t,e){var n=t("errno").create,r=n("LevelUPError"),i=n("NotFoundError",r)
i.prototype.notFound=!0,i.prototype.status=404,e.exports={LevelUPError:r,InitializationError:n("InitializationError",r),OpenError:n("OpenError",r),ReadError:n("ReadError",r),WriteError:n("WriteError",r),NotFoundError:i,EncodingError:n("EncodingError",r)}},{errno:26}],16:[function(t,e){(function(n){function r(t,e){return"function"==typeof t?t:e}function i(t,e,r){if(!(this instanceof i))return new i(t,e,r)
var o
...
return t=u(this.options,t),new m(t,this,function(t){return e.db.iterator(t)})},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(u(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(u(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new y(u(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=b.copy,e.exports.destroy=o("destroy"),e.exports.repair=o("repair")}).call(this,t("Zh58VX"))},{"./batch":14,"./errors":15,"./read-stream":17,"./util":18,"./write-stream":19,Zh58VX:103,"deferred-leveldown":21,events:97,prr:27,util:124,xtend:38}],17:[function(t,e){function n(t,e,i){if(!(this instanceof n))return new n(t,e,i)
...
e.exports={defaultOptions:w,copy:i,getOptions:o,getLevelDOWN:s,dispatchError:a,encodeKey:h,encodeValue:f,isValueAsBuffer:d,isKeyAsBuffer:g,decodeValue:p,decodeKey:l}}).call(this,t("Zh58VX"),t("buffer").Buffer)},{"../package.json":39,"./errors":15,Zh58VX:103,buffer:94,leveldown:93,"leveldown/package":93,semver:93,xtend:38}],19:[function(t,e){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:103}],23:[function(t,e){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Zh58VX"))},{Zh58VX:103}],24:[function(t,e){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
return n})},{}],28:[function(t,e){(function(n){function r(t){return this instanceof r?(u.call(this,t),c.call(this,t),t&&t.readable===!1&&(this.readable=!1),t&&t.writable===!1&&(this.writable=!1),this.allowHalfOpen=!0,t&&t.allowHalfOpen===!1&&(this.allowHalfOpen=!1),void this.once("end",i)):new r(t)}function i(){this.allowHalfOpen||this._writableState.ended||n.nextTick(this.end.bind(this))}function o(t,e){for(var n=0,r=t.length;r>n;n++)e(t[n],n)}e.exports=r
...
a.inherits(r,u),o(s(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Zh58VX"))},{"./_stream_readable":30,"./_stream_writable":32,Zh58VX:103,"core-util-is":33,inherits:34}],29:[function(t,e){function n(t){return this instanceof n?void r.call(this,t):new n(t)}e.exports=n
var r=t("./_stream_transform"),i=t("core-util-is")
i.inherits=t("inherits"),i.inherits(n,r),n.prototype._transform=function(t,e,n){n(null,t)}},{"./_stream_transform":31,"core-util-is":33,inherits:34}],30:[function(t,e){(function(n){function r(e){e=e||{}
...
null!==t.writechunk&&t.writecb&&!t.transforming?(t.transforming=!0,this._transform(t.writechunk,t.writeencoding,t.afterTransform)):t.needTransform=!0}},{"./_stream_duplex":28,"core-util-is":33,inherits:34}],32:[function(t,e){(function(n){function r(t,e,n){this.chunk=t,this.encoding=e,this.callback=n}function i(t,e){t=t||{}
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],42:[function(t,e){e.exports=t(22)},{Zh58VX:103}],43:[function(t,e){e.exports=t(23)},{Zh58VX:103}],44:[function(t,e,n){arguments[4][24][0].apply(n,arguments)},{"./abstract-chained-batch":42,"./abstract-iterator":43,Zh58VX:103,buffer:94,xtend:46}],45:[function(t,e){e.exports=t(7)},{}],46:[function(t,e,n){arguments[4][8][0].apply(n,arguments)},{"./has-keys":45,"object-keys":48}],47:[function(t,e){var n=Object.prototype.hasOwnProperty,r=Object.prototype.toString,i=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===r.call(t)
...
else for(o in t)n.call(t,o)&&(null===u?e(t[o],o,t):e.call(u,t[o],o,t))}},{}],48:[function(t,e,n){arguments[4][9][0].apply(n,arguments)},{"./shim":50}],49:[function(t,e){var n=Object.prototype.toString
e.exports=function r(t){var e=n.call(t),r="[object Arguments]"===e
return r||(r="[object Array]"!==e&&null!==t&&"object"==typeof t&&"number"==typeof t.length&&t.length>=0&&"[object Function]"===n.call(t.callee)),r}},{}],50:[function(t,e){!function(){"use strict"
...
return i=r(),i.noConflict=function(){return e&&(e[t]=o),i},i})},{}],56:[function(t,e){function n(t){if(!t||"[object Object]"!==i.call(t)||t.nodeType||t.setInterval)return!1
...
return u}},{}],57:[function(t,e){var n=t("stringmap"),r=t("level-sublevel"),i=t("asynquence"),o=t("events").EventEmitter,s=t("expire-unused-keys"),a=t("extend")
...
return v.on("expire",f),g.on("expire",h),y.stop=c,y.get=function(t,e){d.get(t,function(n,r){n&&n.notFound?f(t,l(t,e)):e&&l(t,e)(n,r)})},y.getLocal=function(t,e){d.get(t,l(t,e))},y.refresh=function(t,e){f(t,l(t,e))},y}},{asynquence:55,events:97,"expire-unused-keys":58,extend:56,"level-sublevel":2,stringmap:59}],58:[function(t,e){function n(t){function e(){n=!1}var n=!1
...
return o.touch=o.emit.bind(o,"touch"),o.forget=o.emit.bind(o,"forget"),o.stop=function(){clearInterval(u)},o}},{events:97}],59:[function(t,e){var n=function(){"use strict"
...
"undefined"!=typeof e&&"undefined"!=typeof e.exports&&(e.exports=n)},{}],60:[function(t,e){var n=t("http"),r=t("url"),i=(t("concat-stream"),t("text-metadata-parser"))
...
e.exports.toByteArray=t,e.exports.fromByteArray=n}()},{}],64:[function(t,e){function n(t,e,n){e=void 0===e?0:e,n=void 0===n?t.length:n
...
var s=t("base64-js"),a={hex:r,utf8:i,base64:o}},{"base64-js":63}],68:[function(t,e){e.exports=function(t){return t instanceof Uint8Array}},{}],69:[function(t,e){function n(t,e){if(!t.length)return new Uint8Array(0)
...
return e}e.exports=n},{}],70:[function(t,e){function n(t){return new DataView(t.buffer,0)}function r(t){var e=o.get(t.buffer)
return e||o.set(t.buffer,e=new DataView(t.buffer,0)),e}var i,o
e.exports=i={},o="undefined"==typeof WeakMap?null:new WeakMap,i.get=o?r:n},{}],71:[function(t,e){function n(t,e){return t[e]}function r(t,e){var n=t[e]
...
var v=t("./mapped.js")},{"./mapped.js":70}],72:[function(t,e){function n(t,e,n){return t.subarray(e||0,n||t.length)}e.exports=n},{}],73:[function(t,e){function n(t,e){return u[e||"utf8"](t)}function r(t){for(var e,n="",r=0,i=t.length;i>r;++r)e=t[r],n+=((240&e)>>>4).toString(16),n+=(15&e).toString(16)
return n}function i(t){return a(t)}function o(t){return s.fromByteArray(t)}e.exports=n
var s=t("base64-js"),a=t("to-utf8"),u={hex:r,utf8:i,base64:o}},{"base64-js":63,"to-utf8":64}],74:[function(t,e){function n(t,e,n){return t[n]=e}function r(t,e,n){return t[n]=0>e?e+256:e}function i(t,e,n){var r=v.get(t)
...
var v=t("./mapped.js")},{"./mapped.js":70}],75:[function(t,e){function n(t){for(var e=t.split("\n"),n=!1,r=!1,i={content:"",metadata:{}},o=0;o<e.length&&!r;o++)if(n)r||(r=!/^\s*$/.test(e[o]))
else{var s=/^([^:]+):\s*([^\r\n]+)\s*$/.exec(e[o])
...
e.exports=function(t){return u.extend(t)}},{extend:56}],77:[function(t,e){function n(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
...
return e.linkify=r.bind(null,e,t),e}},{events:97}],78:[function(t,e){function n(t,e){function n(t){u.mixinHtml(t),u.parseTemplate(t),u.mixinChildPosts(t),u.mixinRenderedHtmlEmitter(t),t.on("all child posts fetched",function(t){t.templateElements.forEach(n)})}function i(t,e){var r=u.makeNewMixinObject(t)
...
e.exports=n},{"./mixins":79}],79:[function(t,e){(function(n){function r(t){try{return new d({el:null,data:t.data,template:t.renderedHtml||t.html,preserveWhitespace:!0}).toHTML()}catch(e){return t.emit("error",e),e.message}}function i(t){var e=Object.create(new p)
...
"undefined"!=typeof e&&e.exports?e.exports=lo:"function"==typeof define&&define.amd&&define(function(){return lo}),t.Ractive=lo,lo.noConflict=function(){return t.Ractive=n,lo}}("undefined"!=typeof window?window:this)},{}],81:[function(t,e){e.exports=function(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}},{}],82:[function(t,e){function n(){return Object.create(new a)}function r(t,e){var n=Object.create(t),r=0
...
e.exports=i},{"./numberOfOccurrances":81,"./templateToolbox":83,events:97}],83:[function(t,e){function n(t){return t.metadata.markdown!==!1?h.makeHtml(t.content):t.content}function r(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(t){var e=16*Math.random()|0,n="x"==t?e:3&e|8
...
e.exports={generateId:i,getPostName:o,generatePostDiv:a,isAPostDiv:s,getTemplateDataObject:u,htmlify:n}},{pagedown:91}],84:[function(t,e){e.exports=function(t){var e={}
return t.on("post changed",function(t,n){e[t]&&e[t].forEach(function(t){t.emit("post changed",n)})}),function(t){"undefined"==typeof e[t.postName]&&(e[t.postName]=[]),e[t.postName].push(t),t.ractive.on("teardown",function(){e[t.postName]=e[t.postName].filter(function(e){return e!==t})})}}},{}],85:[function(t,e){var n=t("levelup"),r=t("localstorage-down"),i=function(t){return new r(t)}
e.exports={clearCache:function(){var t=n("noddity-content",{db:i})
t.createKeyStream().on("data",function(e){t.del(e)})}}},{levelup:16,"localstorage-down":40}],86:[function(t){var e=t("noddity-butler"),n=t("levelup"),r=t("noddity-linkifier"),i=t("localstorage-down"),o=t("./routing"),s=t("./mainViewModel"),a=t("level-sublevel"),u=noddityConfig,c=function(t){return new i(t)},h=a(n("noddity-content",{db:c})),f=u.title.replace(/[^\w]+/g,""),l=u.debug?{refreshEvery:3e4}:void 0,p=new e(u.noddityRoot,h.sublevel(f),l),d=new r(u.pathPrefix+u.pagePathPrefix),g=new s(p,d),v=o()
v.on("current",g.setCurrent),u.debug&&(window.debug=t("./debug"))},{"./debug":85,"./mainViewModel":87,"./routing":88,"level-sublevel":2,levelup:16,"localstorage-down":40,"noddity-butler":51,"noddity-linkifier":77}],87:[function(t,e){function n(){}var r=t("ractive"),i=noddityConfig,o=t("noddity-renderer")
...
return i.sidebar&&t.getPost(i.sidebar,function(t,e){t?g.set("html",t.message):h.populateRootRactive(e,g)}),e.on("link",function(e){t.getPost(e,n)}),t.on("post changed",c),t.on("index changed",a),{setCurrent:u}}},{"noddity-renderer":78,ractive:92}],88:[function(t,e){var n=noddityConfig,r=t("events").EventEmitter
...
return setTimeout(e.go.bind(e),0),t}},{events:97}],89:[function(t,e,n){var r
...
return a})}()},{}],102:[function(t,e){e.exports=t(34)},{}],103:[function(t,e){function n(){}var r=e.exports={}
...
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":105,"./encode":106}],108:[function(t,e){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":109}],109:[function(t,e){e.exports=t(28)},{"./_stream_readable":111,"./_stream_writable":113,Zh58VX:103,"core-util-is":114,inherits:102}],110:[function(t,e){e.exports=t(29)},{"./_stream_transform":112,"core-util-is":114,inherits:102}],111:[function(t,e){e.exports=t(30)},{Zh58VX:103,buffer:94,"core-util-is":114,events:97,inherits:102,isarray:115,stream:121,"string_decoder/":116}],112:[function(t,e){e.exports=t(31)},{"./_stream_duplex":109,"core-util-is":114,inherits:102}],113:[function(t,e){e.exports=t(32)},{"./_stream_duplex":109,Zh58VX:103,buffer:94,"core-util-is":114,inherits:102,stream:121}],114:[function(t,e){e.exports=t(33)},{buffer:94}],115:[function(t,e){e.exports=t(35)},{}],116:[function(t,e){e.exports=t(36)},{buffer:94}],117:[function(t,e){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":110}],118:[function(t,e){e.exports=t(37)},{"./lib/_stream_duplex.js":109,"./lib/_stream_passthrough.js":110,"./lib/_stream_readable.js":111,"./lib/_stream_transform.js":112,"./lib/_stream_writable.js":113}],119:[function(t,e){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":112}],120:[function(t,e){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":113}],121:[function(t,e){function n(){r.call(this)}e.exports=n
...
return t}}).call(this,t("Zh58VX"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":123,Zh58VX:103,inherits:102}]},{},[86])
